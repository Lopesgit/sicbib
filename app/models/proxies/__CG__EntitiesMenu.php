...
class Menu extends \Entities\Menu implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'nome', 'has_sub', 'url', 'ordem', 'subMenus', 'funcionalidades');
        }
    ...
    public function addSubmenu($submenu)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addSubmenu', array($submenu));
    ...
    public function setSubMenus($subMenus)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setSubMenus', array($subMenus));
